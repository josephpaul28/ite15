    ...
    <div class="container">
        <div class="page-content">      
            <div class="col-md-12">
                ...
                <p class="text-404"><?php esc_html_e( 'Don\'t worry it happens to the best of us.', 'food-restaurant' ); ?></p>
                <div class="read-moresec">
                    <div><a href="<?php echo esc_url( home_url() ); ?>" class="button"><?php esc_html_e( 'Back to Home Page', 'food-restaurant' ); ?></a></div>
                </div>
            </div>
